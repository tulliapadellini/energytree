...
par(mfrow=c(3,3))
 ...
 lines(data[[14]]$V1[20], lwd=2, col="gray20")
 plot(data[[14]]$V2[1:50], col="red", main="V2")
 lines(data[[14]]$V2[20], lwd=2, col="gray20")
 plot(data[[14]]$V3[1:50], col="red", main="V3")
 lines(data[[14]]$V3[20], lwd=2, col="gray20")
 ...
 lines(data[[14]]$V1[120], lwd=2, col="purple")
 plot(data[[14]]$V2[101:150], col="green", main="")
 lines(data[[14]]$V2[115], lwd=2, col="purple")
 plot(data[[14]]$V3[101:150], col="green", main="")
 lines(data[[14]]$V3[120], lwd=2, col="purple")
dev.off() 
