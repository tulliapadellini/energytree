...
mb_cl_fun_1 <- microbenchmark(etree(response = resp1,
...
mb_cl_fun_2 <- microbenchmark(etree(response = resp2,
...
mb_cl_fun_3 <- microbenchmark(etree(response = resp3,
...
mb_cl_ft1_1 <- microbenchmark(etree(response = resp1,
                                    covariates = cov.list1,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft1_2 <- microbenchmark(etree(response = resp2,
                                    covariates = cov.list2,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft1_3 <- microbenchmark(etree(response = resp3,
                                    covariates = cov.list3,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft2_1 <- microbenchmark(etree(response = resp1,
                                    covariates = cov.list1,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft2_2 <- microbenchmark(etree(response = resp2,
                                    covariates = cov.list2,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft2_3 <- microbenchmark(etree(response = resp3,
                                    covariates = cov.list3,
                                    case.weights = NULL,
                                    minbucket = 10,
                                    alpha = 0.05,
...
mb_cl_ft3_1 <- microbenchmark(etree(response = resp1,
                                    covariates = cov.list1,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft3_2 <- microbenchmark(etree(response = resp2,
                                    covariates = cov.list2,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft3_3 <- microbenchmark(etree(response = resp3,
                                    covariates = cov.list3,
                                    case.weights = NULL,
                                    minbucket = 10,
                                    alpha = 0.05,
...
mb_cl_ft4_1 <- microbenchmark(etree(response = resp1,
                                    covariates = cov.list1,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft4_2 <- microbenchmark(etree(response = resp2,
                                    covariates = cov.list2,
                                    case.weights = NULL,
                                    minbucket = 5,
                                    alpha = 0.05,
...
mb_cl_ft4_3 <- microbenchmark(etree(response = resp3,
                                    covariates = cov.list3,
                                    case.weights = NULL,
                                    minbucket = 10,
                                    alpha = 0.05,
